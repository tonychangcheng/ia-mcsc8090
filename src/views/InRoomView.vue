  ...
  computed: {
    ...
    template: function () {
      ...
      let templates = [
        ...
        '',
        '',
        '陈永仁🧙‍♂️、黄志诚🛡️、Mary姐😈、韩琛🔪、1警员🙌',
        '陈永仁🧙‍♂️、黄志诚🛡️、Mary姐😈、韩琛🔪、2警员🙌',
        '陈永仁🧙‍♂️、黄志诚🛡️、Mary姐😈、韩琛🔪、大B👻、2警员🙌',
        '陈永仁🧙‍♂️、黄志诚🛡️、刘建明👹、Mary姐😈、傻强💀、3警员🙌',
        '陈永仁🧙‍♂️、黄志诚🛡️、刘建明👹、Mary姐😈、韩琛🔪、4警员🙌',
        '陈永仁🧙‍♂️、黄志诚🛡️、刘建明👹、Mary姐😈、韩琛🔪、大B👻、4警员🙌'
      ];
    ...
    chineseRoleName: function () {
      let roleName = {
        ...
        'Morgana': 'Mary姐😈',
        'Assassin': '韩琛🔪',
        'Loyal Servant of Arther': '警员🙌',
        'Oberon': '大B👻',
        'Minion of Mordred': '傻强💀'
      }
  ...
  mounted: function () {
    ...
    axios({
      ...
      .then((response) => {
        ...
        let roleUserSees = {
          'Merlin': '你知道的坏人',
          'Percival': '一个是陈永仁🧙‍♂️，另一个是Mary姐😈',
          'Mordred': '你的黑帮队友',
          'Morgana': '你的黑帮队友',
          'Assassin': '你的黑帮队友',
          'Loyal Servant of Arther': '', // 对于警员🙌，没有额外信息
          'Oberon': '你是大B👻，你不知道你的黑帮队友是谁', // 对于大B👻，没有额外信息
